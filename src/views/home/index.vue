<template>
  <div class="home">
    <h1 class="font_tz">titile this is title</h1>
    <div>
  ...
  data () {
    return {
      ...
      list: [
        {
          title: 'title1',
          content: 'this is title1 content',
          name: 'title1',
          url: 'https://github.com/tim760255458/pwa-project'
        },
        {
          title: 'title2',
          content: 'this is title2 content',
          name: 'title2',
...
.home {
  > h1 {
    color: $color_title;
    text-shadow: 2px 2px 3px $color_sub;
  }
  > div {
    display: flex;
    .card {
